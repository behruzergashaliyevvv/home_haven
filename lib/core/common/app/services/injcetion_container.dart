...
Future<void> prodactInit() async {
  getIt
    ..registerLazySingleton(() => GetProductUsecase(productrepo: getIt()))
    ..registerLazySingleton<Productrepo>(
      () => ProducTRepoImpl(productRemoteDataSourse: getIt()),
    )
    ..registerLazySingleton<ProductRemoteDataSourse>(
